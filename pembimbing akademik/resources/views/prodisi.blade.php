        ...
        <div class="container-xxl position-relative p-0">
                    ...
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                ...
                                <a href="{{ url('/prodisi') }}" class="dropdown-item active">Sistem Informasi</a>
            ...
            <div class="container-xxl py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5 pt-5 pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Prodi Sistem Infromasi</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            <li class="breadcrumb-item"><a href="#">Beranda</a></li>
                            <li class="breadcrumb-item"><a href="#">Program Studi</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">Sistem Informasi</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5">Program Studi Sistem Informasi </h1>
                </div>
                <div class="container mt-5">
                    ...
                    <div class="mt-5">
                        ...
                        <ul>
                            ...
                            <li>Dosen</li>
                            <li>Praktisi Sistem Informasi</li>
