    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="../admin/prodi" class="nav-link">Prodi</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="../admin/dosen" class="nav-link">Dosen</a>
                </li>
               
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="../admin/mahasiswa" class="nav-link">Mahasiswa</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="../admin/rombongan_belajar" class="nav-link">Rombel</a>
                </li>
            </ul>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <div class="dropdown-divider"></div>
                        <a href="#" class="dropdown-item dropdown-footer">Empety Message</a>
                    </div>
                </li>
