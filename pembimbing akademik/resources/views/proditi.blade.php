        ...
        <div class="container-xxl position-relative p-0">
                    ...
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                <a href="{{ url('/proditi') }}" class="dropdown-item active">Teknik Informatika</a>
            ...
            <div class="container-xxl py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5 pt-5 pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Prodi Teknik Informatika</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            <li class="breadcrumb-item"><a href="#">Beranda</a></li>
                            <li class="breadcrumb-item"><a href="#">Program Studi</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">Teknik Informatika</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5">Program Studi Teknik Informatika </h1>
                </div>
                <div class="container mt-5">
                    <p>
                        Teknik Informatika adalah rumpun ilmu terapan yang mengaplikasikan bagaimana proses merancang suatu aplikasi website atau aplikasi mobile serta merancang infrastruktur teknologi, dengan kata lain Informatika merupakan ilmu yang mempelajari terkait penggunaan komputer untuk mengatur dan menganalisis data yang berukuran besar, baik data maupun informasi pada mesin berbasis komputasi.
                    </p>
                    <div class="mt-5">
                        <h2>Peminatan TI</h2>
                        <ul>
